          ...
          <div className="w-full h-[79px] flex items-center justify-between p-3">
            <div>
              ...
              >
                {/* Bright Years */}
                <Image
                  src={require(`../../public/assets/logo_${
                    activeImg ? "light" : "dark"
                  }.png`)}
                  alt="Bright Years Hero"
                  width={100}
                  className="object-contain mx-auto justify-items-center"
                />
              </Link>
            </div>
            <div className="flex items-center">
              <NavItems activeItem={activeItem} isMobile={false} />
              <ThemeSwitcher onChange={(isDark) => setActiveImg(isDark)} />
              {/* only for mobile */}
                ...
                {userData ? (
                  <Link href={"/profile"}>
                    <Image
                      ...
                      height={30}
                      alt=""
                      className="ml-[20px] w-[30px] h-[30px] object-cover rounded-full cursor-pointer"
                      style={{
                        border: activeItem === 5 ? "2px solid #37a39a" : "none",
                      }}
                    />
