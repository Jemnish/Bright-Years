...
courseRouter.post(
  ...
  course_controller_1.uploadCourse
);
courseRouter.put(
  "/edit-course/:id",
  auth_1.isAuthenticated,
...
courseRouter.put(
  ...
  auth_1.isAuthenticated,
  (0, auth_1.authorizeRoles)("admin"),
  course_controller_1.addReplyToReview
);
courseRouter.get(
  "/get-admin-courses",
  auth_1.isAuthenticated,
  (0, auth_1.authorizeRoles)("admin"),
  course_controller_1.getAdminCourses
);
...
courseRouter.delete(
  ...
  auth_1.isAuthenticated,
  (0, auth_1.authorizeRoles)("admin"),
  course_controller_1.deleteCourse
);
