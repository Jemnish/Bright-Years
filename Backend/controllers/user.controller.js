...
exports.registrationUser = (0, catchAsyncErrors_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        console.log(path_1.default.join(__dirname, "../mails/activation-mail.ejs"));
...
(req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        const user = yield user_model_1.default.findOne({ email }); // Mencari pengguna berdasarkan alamat email
        if (!user) { // Jika pengguna tidak ditemukan
            const newUser = yield user_model_1.default.create({ email, name, avatar }); // Buat pengguna baru dengan informasi yang diberikan
...
exports.updateProfilePicture = (0, catchAsyncErrors_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _f, _g, _h;
    try {
        const { avatar } = req.body; // This will be base64 image string
