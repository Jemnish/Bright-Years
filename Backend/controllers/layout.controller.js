...
exports.editLayout = (0, catchAsyncErrors_1.CatchAsyncError)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        ...
        if (type === "Categories") {
            const { categories } = req.body;
            const CategoriesItem = yield layout_model_1.default.findOne({ type: "Categories" });
            const categoriesItems = yield Promise.all(categories.map((item) => __awaiter(void 0, void 0, void 0, function* () {
                return {
                    title: item.title
                };
            })));
            yield layout_model_1.default.findByIdAndUpdate(CategoriesItem === null || CategoriesItem === void 0 ? void 0 : CategoriesItem._id, { type: "Categories", categories: categoriesItems });
        }
        res.status(200).json({
            success: true,
